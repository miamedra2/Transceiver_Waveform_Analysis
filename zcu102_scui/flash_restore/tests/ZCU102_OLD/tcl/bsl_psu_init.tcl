...
set psu_mio_init_data {
    ...
    # ctl- (TX RGMII control)
		...
		# Level 1 Mux Select 0= Level 2 Mux Output 1= pcie, Input, pcie_reset_n- (
    # PCIE Reset signal)
		# PSU_IOU_SLCR_MIO_PIN_31_L1_SEL                                                  1
    ...
    # ut) 7= trace, Output, tracedq[9]- (Trace Port Databus)
		...
		#(OFFSET, MASK, VALUE)      (0XFF18007C, 0x000000FEU ,0x00000004U)  */
    mask_write 0XFF18007C 0x000000FE 0x00000004
    ...
    mask_write 0XFF1800FC 0x000000FE 0x00000004
		...
		#(OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x82240000U)  */
    mask_write 0XFF180204 0xFFFFFFFF 0x82240000
...
set psu_peripherals_init_data {
		...
		#(OFFSET, MASK, VALUE)      (0XFD1A0100, 0x000E007EU ,0x00000000U)  */
    mask_write 0XFD1A0100 0x000E007E 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
...
set psu_serdes_init_data {
    ...
    #  - 108MHz, 0xF - 125MHz, 0x10 - 135MHz, 0x11 - 150 MHz. 0x12 to 0x1F - R
    # eserved
		# PSU_SERDES_PLL_REF_SEL3_PLLREFSEL3                                              0x11

		# PLL3 Reference Selection Register
		#(OFFSET, MASK, VALUE)      (0XFD41000C, 0x0000001FU ,0x00000011U)  */
    mask_write 0XFD41000C 0x0000001F 0x00000011
    ...
    mask_write 0XFD40A36C 0x00000007 0x00000003
		...
		# Spread Spectrum No of Steps [7:0]
		# PSU_SERDES_L3_PLL_SS_STEPS_0_LSB_SS_NUM_OF_STEPS_0_LSB                          0x18

		# Spread Spectrum No of Steps bits 7:0
		#(OFFSET, MASK, VALUE)      (0XFD40E368, 0x000000FFU ,0x00000018U)  */
    mask_write 0XFD40E368 0x000000FF 0x00000018
    ...
    mask_write 0XFD40E370 0x000000FF 0x000000D3
    ...
    mask_write 0XFD40E374 0x000000FF 0x000000DA
    ...
    mask_write 0XFD40D8F8 0x000000FF 0x00000096
    ...
    mask_write 0XFD40D8FC 0x000000FF 0x00000096
    ...
    mask_write 0XFD40D900 0x000000FF 0x00000096
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD0C00AC 0xFFFFFFFF 0x28184D1B
    ...
    mask_write 0XFD0C00B0 0xFFFFFFFF 0x0E081906
...
set psu_afi_config {
    ...
    mask_write 0XFF419000 0x00000300 0x00000200
}
